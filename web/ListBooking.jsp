...
<%
    ...
    ArrayList<Booking> list = dbObj.getBooking();
...
<html>
 ...
 <%
                    ...
                    <tr>
                        ...
                        <td><%=booking.getPaymentType()%></td>
                          <td><%=booking.getAmount()%></td>
                        
                        <td><a href="Controller?bookingId=<%=booking.getBookingId()%>&controllerLabel=DeleteBooking">Delete</a></td>
                    </tr>
                    <%
                        }
                    %>
